...
@State(name = "HippoFreemarkerEditor", storages = {@Storage(id = "dir", file = StoragePathMacros.APP_CONFIG + "/hippo_freemarker_editor.xml", scheme = StorageScheme.DIRECTORY_BASED)})
public class ApplicationComponent implements com.intellij.openapi.components.ApplicationComponent, Configurable, PersistentStateComponent<Element> {
    ...
    public static final String FREEMARKER_DIR_ATTRIBUTE = "freemarkerDirectory";
    public static final String USERENAME_ATTRIBUTE = "username";
    public static final String PASSWORD_ATTRIBUTE = "password";
    public static final String RMI_ATTRIBUTE = "rmiAddress";

    public static final String CONFIGURATION_CONFIG_ELEMENT = "hippo-freemarker-config";
    private String username;
    private String password;
    private String rmiAddress;
    private String freemarkerDirectory;
    ...
    public String getComponentName() {
        return "HippoFreemarkerEditorComponent";
    }

    @Override
    public Element getState() {
        final Element element = new Element(CONFIGURATION_CONFIG_ELEMENT);
        checkNullSave(element, FREEMARKER_DIR_ATTRIBUTE, freemarkerDirectory);
    ...
    public void loadState(final Element element) {
        freemarkerDirectory = element.getAttributeValue(FREEMARKER_DIR_ATTRIBUTE);
    ...
    public String getFreemarkerDirectory() {
        return freemarkerDirectory;
    }

    public void setFreemarkerDirectory(final String freemarkerDirectory) {
        this.freemarkerDirectory = freemarkerDirectory;
    }
