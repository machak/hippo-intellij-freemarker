...
package org.onehippo.intellij.freemarker.config;
...
public class PluginConfiguration extends BaseConfigurable {
    ...
    private TextFieldWithBrowseButton freemarkerDirectory;
    private JLabel freemarkerLabel;
    ...
    public PluginConfiguration() {
        ...
        final DocumentListener listener = new DocumentAdapter() {
            ...
            protected void textChanged(DocumentEvent documentEvent) {
                freemarkerDirectory.getText();
            }
        };
        freemarkerDirectory.getChildComponent().getDocument().addDocumentListener(listener);
        freemarkerDirectory.setTextFieldPreferredWidth(50);
        freemarkerDirectory.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                chooseFolder(freemarkerDirectory, false);
            }
        });
    ...
    public String getDisplayName() {
        return "Hippo freemarker editor";
    }
    ...
    public boolean isModified(ApplicationComponent component) {
        ...
        final String freemarkerText = freemarkerDirectory.getText();
        final String freemarkerDir = component.getFreemarkerDirectory();
        boolean textChanged = isTextChanged(freemarkerText, freemarkerDir);
        if (textChanged) {
            return true;
        }
    ...
    public void storeDataTo(ApplicationComponent component) {
        ...
        component.setFreemarkerDirectory(freemarkerDirectory.getText());
    ...
    public void readDataFrom(ApplicationComponent component) {
        ...
        freemarkerDirectory.setText(component.getFreemarkerDirectory());
    ...
    private void chooseFolder(final TextAccessor field, final boolean chooseFiles) {
        ...
        descriptor.setTitle("Select Freemarker Root Folder");
